...
add_library(sqlite3
 ${CMAKE_CURRENT_SOURCE_DIR}/SQLiteCpp/sqlite3/sqlite3.c
 ${CMAKE_CURRENT_SOURCE_DIR}/SQLiteCpp/sqlite3/sqlite3.h
)

target_include_directories(sqlite3 PUBLIC ${CMAKE_CURRENT_SOURCE_DIR}/SQLiteCpp/sqlite3)
...
install(TARGETS sqlite3
    ...
    COMPONENT libraries)
install(FILES ${CMAKE_CURRENT_SOURCE_DIR}/SQLiteCpp/sqlite3/sqlite3.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} COMPONENT headers)
