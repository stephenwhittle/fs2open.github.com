...
void check_version(const char* libname, uint32_t current, uint32_t compiled)
{
	...
	{
		core::Error(LOCATION, "The major version of the %s library is not the same as the one this executable was compiled with!\n"
	...
	{
		core::Error(LOCATION, "The minor version of the %s library is not the same as the one this executable was compiled with!\n"
