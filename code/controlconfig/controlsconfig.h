...
extern std::vector<config_item*> Control_config_presets; // tabled control presets; pointers to config_item arrays
extern std::vector<std::string> Control_config_preset_names; // names for Control_config_presets (identical order of items)
