...
const DeserializationHandlers<SCP::ThrusterAnimInfo> SCPTableBase<SCP::ThrusterAnimInfo>::Deserializers = {
	...
	{SCPTableFormatDescriptor::GetVariableName("+Pri_Afterburn"), ReplaceValue(&SCP::ThrusterAnimInfo::PrimaryAfterburn)},
	...
	{SCPTableFormatDescriptor::GetVariableName("+Sec_Afterburn"), ReplaceValue(&SCP::ThrusterAnimInfo::SecondaryAfterburn)},
	{SCPTableFormatDescriptor::GetVariableName("+Ter_Normal"), ReplaceValue(&SCP::ThrusterAnimInfo::TertiaryNormal)},
	{SCPTableFormatDescriptor::GetVariableName("+Ter_Afterburn"), ReplaceValue(&SCP::ThrusterAnimInfo::TertiaryAfterburn)},
	{SCPTableFormatDescriptor::GetVariableName("+Dist_Normal"), ReplaceValue(&SCP::ThrusterAnimInfo::DistortionNormal)},
	{SCPTableFormatDescriptor::GetVariableName("+Dist_Afterburn"), ReplaceValue(&SCP::ThrusterAnimInfo::DistortionAfterburn)}
...
const DeserializationHandlers<SCP::SpeciesDefaults>
	SCPTableBase<SCP::SpeciesDefaults>::Deserializers = {
		...
		{SCPTableFormatDescriptor::GetVariableName("+Debris_Texture"), DeserializeToField(&SCP::SpeciesDefaults::DebrisTexture)},
		{SCPTableFormatDescriptor::GetVariableName("+Shield_Hit_ani"), DeserializeToField(&SCP::SpeciesDefaults::ShieldHitAni)},
		{"AnimInfo", Merge(&SCP::SpeciesDefaults::ThrusterAnims)},
		{"GlowInfo", Merge(&SCP::SpeciesDefaults::GlowBitmaps)},
		{SCPTableFormatDescriptor::GetVariableName("$AwacsMultiplier"), DeserializeToField(&SCP::SpeciesDefaults::AwacsMultiplier)},
		{SCPTableFormatDescriptor::GetVariableName("$Countermeasure type"), DeserializeToField(&SCP::SpeciesDefaults::CountermeasureType)}
